    ...
    <article id="post-988" class="post-988 page type-page status-publish hentry">
        ...
        <div id="tinymce" class="entry-content">
            <section class="contained">
                ...
                $access_token='433525161.06163e4.1fe876438e404aa2aaf2ca650c486795'; //Provide your instagram access token
                $count='20'; //How many shots do you want?

                //2 - Include the php class
                include('instagram.php');
                //3 - Instanciate
                if(!empty($username) && $username!='yourusername' && !empty($access_token) && $access_token!='433525161.06163e4.1fe876438e404aa2aaf2ca650c486795'){
